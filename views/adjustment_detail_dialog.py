...
class AdjustmentDetailDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # 1. 顶部指标汇总 (增加了红色的波及列车数)
        summary_text = (f"<b>算法:</b> {self.algo_name} &nbsp;&nbsp;|&nbsp;&nbsp; "
                        f"<b>计算耗时:</b> {self.duration:.3f} 秒<br>"
                        f"<b>区段总加权晚点:</b> {self.section_delay:.2f} 分钟 &nbsp;&nbsp;|&nbsp;&nbsp; "
                        f"<b>终点站晚点:</b> {self.terminal_delay:.2f} 分钟 &nbsp;&nbsp;|&nbsp;&nbsp; "
                        f"<span style='color: #D32F2F;'><b>波及列车数:</b> {self.adjusted_count} 列</span>")
